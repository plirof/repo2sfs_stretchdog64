...
cat > $1/usr/bin/waterfox-puppy << EOF
#!/bin/sh
...
EOF
chmod 755 $1/usr/bin/waterfox-puppy
...
cat > $1/usr/bin/waterfox-puppy-sda1 << EOF31
#####   SDA1 #####################################################
...
EOF31
chmod 755 $1/usr/bin/waterfox-puppy-sda1
...
cat > $1/usr/bin/waterfox-puppy-sdb1 << EOF41
#!/bin/sh
...
su -l puppy -c 'waterfox -profile "/mnt/sda1/downloads_linux/.data/waterfox" \$1'
EOF41
chmod 755 $1/usr/bin/waterfox-puppy-sdb1
