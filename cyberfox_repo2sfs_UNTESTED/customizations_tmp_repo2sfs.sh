...
#su - puppy -c "/usr/bin/cyberfox  --user-data-dir=/home/puppy/cyberfox_puppy_user_data_dir --ppapi-flash-path=/usr/lib/adobe-flashplugin/libpepflashplayer.so --ppapi-flash-version=26.0.0.137"
su -l puppy -c "cyberfox --user-data-dir=/mnt/sda1/downloads_linux/.data/cyberfox --disk-cache-dir=/mnt/sda1/downloads_linux/.cache/cyberfox --ppapi-flash-path=/usr/lib/adobe-flashplugin/libpepflashplayer.so --disable-translate --always-authorize-plugins  --ppapi-flash-version=29.0.0.171 \$1"
EOF31
